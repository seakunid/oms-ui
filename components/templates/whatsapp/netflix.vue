...
export default {
  ...
  methods: {
    setTemplate(user) {
      return `Halo kak *${user.name}*,\n`
            ...
            + `Akun dan Profile Netflix akan dinonaktifkan jika tidak melakukan pembayaran setelah *${user.expiredDate}*. Terimakasih 🙏🏻\n\n`
  ...
  handleCopyRekening(user) {
      ...
      const elementText = templateElement.textContent
